    ...
    public void test() throws IOException{
        for(int i =1 ; i <= rowCount ; i++ ){
            for(int j =1 ; j <= columnCount ; j++ ) {
                if(i == 1) {
                    //Get header value
                    tableVal[i - 1][j - 1] = driver.findElement(By.xpath("//*[@id='ApprHistTable']/table[2]/tbody/tr[" + i + "]/th[" + j + "]")).getText();
                    System.out.println(driver.findElement(By.xpath("//*[@id='ApprHistTable']/table[2]/tbody/tr[" + i + "]/th[" + j + "]")).getText());
                }
                else{
                    //get table data values
                    tableVal[i-1][j-1] =driver.findElement(By.xpath("//*[@id='ApprHistTable']/table[2]/tbody/tr["+i+"]/td["+j+"]")).getText();
                    System.out.println(driver.findElement(By.xpath("//*[@id='ApprHistTable']/table[2]/tbody/tr["+i+"]/td["+j+"]")).getText());
                }
            }
            }
